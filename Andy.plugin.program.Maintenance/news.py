...
ADDON        =  xbmcaddon.Addon(id='Andy.plugin.program.Maintenance')
AddonID      =  'Andy.plugin.program.Maintenance'
AddonTitle   =  "[COLOR=yellow]Andy[/COLOR] Maintenance"
...
def Grab_News(url):
    ...
    buildsURL = 'https://raw.githubusercontent.com/halikus/_AndyRepo/master/_txt/News.txt'
    link = extras.Open_URL(buildsURL).replace('\n','').replace('\r','')
