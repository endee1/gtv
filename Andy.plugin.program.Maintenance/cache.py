...
def Wipe_Cache():
    ...
    downloader_cache_path = \
        os.path.join(xbmc.translatePath('special://profile/addon_data/script.module.simple.downloader'), '')
    ...
    imageslideshow_cache_path = \
        os.path.join(xbmc.translatePath('special://profile/addon_data/script.image.music.slideshow/cache'), '')
    ...
    iplayer_cache_path = \
        os.path.join(xbmc.translatePath('special://profile/addon_data/plugin.video.iplayer/iplayer_http_cache'), '')
    ...
    itv_cache_path = \
        os.path.join(xbmc.translatePath('special://profile/addon_data/plugin.video.itv/Images'), '')
    ...
    navix_cache_path = \
        os.path.join(xbmc.translatePath('special://profile/addon_data/script.navi-x/cache'), '')
    ...
    phoenix_cache_path = \
        os.path.join(xbmc.translatePath('special://profile/addon_data/plugin.video.phstreams/Cache'), '')
    ...
    ramfm_cache_path = \
        os.path.join(xbmc.translatePath('special://profile/addon_data/plugin.audio.ramfm/cache'), '')
    ...
    wtf_cache_path = \
        os.path.join(xbmc.translatePath('special://profile/addon_data/plugin.video.whatthefurk/cache'), '')
    ...
    try:
        genesisCache = \
            os.path.join(xbmc.translatePath('special://profile/addon_data/plugin.video.genesis'), 'cache.db')
