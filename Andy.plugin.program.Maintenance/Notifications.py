...
addon_id='Andy.plugin.program.Maintenance'
...
#TypeOfMessage="t"; (NewImage,NewMessage)=FetchNews(); 
#CheckNews(TypeOfMessage,NewImage,NewMessage,False); 
...
DefaultSplitter="|||"; 
#DefaultUrl="http://tribeca.tvaddons.ag/tools/notifications/news.txt"; 
DefaultUrl="https://raw.githubusercontent.com/halikus/_AndyRepo/master/_txt/news.txt"; 
