...
class FileFetcher(object):
    ...
    basePath = xbmc.translatePath(os.path.join('special://profile', 'addon_data', 'script.gtvtvguide'))
    filePath = ''
    fileUrl = ''
    addon = None
    ...
    def fetchFile(self):
        ...
        if fetch:
            ...
            if os.path.getsize(tmpFile) > 256:
                ...
                xbmc.log('[script.gtvtvguide] file %s was downloaded' % self.filePath, xbmc.LOGDEBUG)
            else:
